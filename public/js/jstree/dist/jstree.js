...
/*jshint -W083 */
	...
	$.jstree.defaults.core = {
		...
		themes			: {
			...
			url				: false,
			/**
			 * the locations of all jstree themes - only used if `url` is set to `true`
	...
	$.jstree.core.prototype = {
      ...
      if (obj && $.inArray(obj.id, this._model.changed) === -1) {
		 ...
		 * @param {mixed} theme_url  the locations of the CSS file for this theme. Omit or set to `false` if you manually included the file. Set to `true` to autoload from the `core.themes.dir` directory.
